...
\begin{figure}[ht]
  ...
  \caption{Each panel displays draws from the GP prior for a single kernel
    bandwidth. While different bandwidths can model different degrees of
...
\citep{paciorek2003nonstationary} approaches have been proposed. Here, we
describe the implementation and application of the approach of
\citep{rasmussen2002infinite}.
