...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{figure/bayes_gibbs_samples}
  \caption{\label{fig:bayes_gibbs_samples} }
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{figure/hdp_gibbs_samples}
  \caption{\label{fig:hdp_gibbs_samples} }
\end{figure}
