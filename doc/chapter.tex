...
characterization of the dynamics within individual regimes.
...
To this end, we have clustered species according the posterior mean of their
$\left(\Theta_{ik}\right)_{k =1}^{K}$. While this does not account for the fact that 
